...
export const homeContent = {
  ...
  /* ── 2. What I Do / Services (Exact 6 Liquid Glass Cards) ──────────────── */
  servicesSection: {
    badge: 'WHAT I DO',
    ...
    services: [
      {
        ...
        description: 'Studio-quality product images using AI.',
        icon: 'camera',
      ...
      },
      {
        ...
        description: 'Use your model or mine for perfect brand shots.',
        icon: 'user',
      ...
      },
      {
        id: 'ugc-ads',
        title: 'UGC & Ads Video',
        description: 'Scroll stopping UGC videos and ad creatives.',
        icon: 'video',
      ...
      },
      {
        ...
        description: 'Creative posters for ads, campaigns and branding.',
        icon: 'pen',
      ...
      },
      {
        ...
        description: 'Custom AI prompts for consistent results.',
        icon: 'prompt',
